...
// -----------------------------------------------------------
export function absorbEntity(player, world, instanceId) {
...
// -----------------------------------------------------------
export function analyzeEntity(player, world, instanceId) {
    const instance = world.entities.get(instanceId);
    if (!instance?.isAlive) {
...
// -----------------------------------------------------------
export function processRespawns(world) {
    const respawned = [];
    const now = Date.now();
...
// -----------------------------------------------------------
export function findNearestEntity(player, world, maxRadius = 80) {
    let nearest = null;
